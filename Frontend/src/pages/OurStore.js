...
const OurStore = () => {
  ...
  // Read category passed from the Header dropdown via React Router location state.
  // This allows "Shop Categories" in the nav to pre-filter the store on arrival.
