...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < orderState?.length; i++) {
      {console.log("orderState", orderState[i])}
      data1.push({
        key: i + 1,
  ...
  (sum, order) => sum + (order.totalPriceAfterDiscount || 0),
  0
);
  ...
  return (
    <div>
      ...
      <div className="d-flex justify-content-between align-items-center gap-3">
        <div className="d-flex p-3 justify-content-between align-items-end flex-grow-1 p-3 roudned-3" style={{ background: "var(--bg-card)" }}>
          <div>
